...
class MedicamentInfoCard extends StatelessWidget {
  final Medicament medicament;

  MedicamentInfoCard({Key key, @required this.medicament}) : super(key: key);
      ...
      builder: (ctx) {
        return AlertDialog(
          content: Container(
              height: 70,
              child: Center(
                  child: Text("Do you want to delete ${medicament.name} ?"))),
          actions: [
  ...
  _showEditMenu(BuildContext context) {
    WidgetKeys.listMedicamentFABkey.currentState.onMeddicamentFABpressed(context, medicament);
  }
